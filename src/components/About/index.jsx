    ...
    <section className="about" id="about">
      ...
      <div ref={ref} className="about--grid">
        <div className="about--bio">
          <h2>
            <ParaWriting stagger={0.08} text={"I'm a versatile software developer with over a year of hands-on experience in frontend and full-stack development. Skilled in technologies such as "} sec={"React, TypeScript, and Firebase"} />
          </h2>
        </div>
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 2 }} onAnimationComplete={() => handleComplete()} className="about--detail">
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>I enjoy building applications that are scalable, performant, and user-friendly. I thrive in collaborative environments where I can leverage both my technical expertise and the user experience.</ScrambleText>
          </p>
        </motion.div>
